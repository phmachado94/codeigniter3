                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtCategoria" class="form-control" placeholder="Nome da Categoria"/>
...
foreach ($categorias as $categoria) {
    ...
    $alterar = anchor(base_url('admin/categoria/alterar/' . md5($categoria->id)), '<i class="fa fa-edit fa-fw"></i> Alterar');
